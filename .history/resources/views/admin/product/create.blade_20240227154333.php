    ...
    <form action="{{ route('admin.product.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="form-group">
                <label for="InputCategory"> {{ __('main.Enter the name') . ' '. __('main.'.$lang->name) }}</label>
                <input type="text" class="form-control" id="InputCategory" placeholder="{{ __('main.Enter the name') . ' '. __('main.'.$lang->name) }}" name="{{ $lang->name }}['name']">
                @error($lang->name)
