...
Route::group(['prefix'=>'profile','middleware'=>'admin.auth'], function () {
    ...
    Route::group(['prefix'=>'product'], function () {
        ...
        Route::group(['prefix'=>'ingredient'], function () {
            Route::get('/', [SizeController::class, 'index'])->name('admin.product.ingredient');
            Route::post('/', [SizeController::class, 'store'])->name('admin.product.ingredient.store');
            Route::get('/create', [SizeController::class, 'create'])->name('admin.product.ingredient.create');
            Route::delete('/{id}', [SizeController::class, 'destroy'])->where('id', '[0-9]+')->name('admin.product.ingredient.destroy');
            Route::get('/edit/{id}', [SizeController::class, 'edit'])->where('id', '[0-9]+')->name('admin.product.ingredient.edit');
            Route::put('/{id}', [SizeController::class, 'update'])->where('id', '[0-9]+')->name('admin.product.ingredient.update');
        });
    });
});
