...
Route::group(['prefix'=>'profile','middleware'=>'admin.auth'], function () {
    ...
    Route::group(['prefix'=>'product'], function () {
        ...
        Route::group(['prefix'=>'size'], function () {
            Route::get('/', [CategoryController::class, 'index'])->name('admin.product.size');
            Route::post('/', [CategoryController::class, 'store'])->name('admin.product.size.store');
            Route::get('/create', [CategoryController::class, 'create'])->name('admin.product.size.create');
            Route::delete('/{id}', [CategoryController::class, 'destroy'])->where('id', '[0-9]+')->name('admin.product.size.destroy');
            Route::get('/edit/{id}', [CategoryController::class, 'edit'])->where('id', '[0-9]+')->name('admin.product.size.edit');
            Route::put('/{id}', [CategoryController::class, 'update'])->where('id', '[0-9]+')->name('admin.product.size.update');
